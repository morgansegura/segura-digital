    ...
    return (
        <div className="services container">
            ...
            <div className="row services__block">
                <div className="services__image left-image col-12 col-md-5 bgimg img-oval">
                    <img className="img-responsive" src={imgBranding} alt="Design & Branding -- " />
                </div>
                <div className="services__content right-content col-12 col-md-6">
                    <h3 className="color--purple-light">Branding & Marketing</h3>
                    <p>
            ...
            <div className="row services__block">
                <div className="services__content left-content col-12 col-md-6">
                    <h3 className="color--blue-light">Interaction & Experience</h3>
                    <p>
                        Bring to the table win-win survival strategies to ensure proactive domination.
                        At the end of the day, going forward, a new normal that has evolved from generation
                        X is on the runway heading towards a streamlined cloud solution. User generated content
                ...
                <div className="services__image right-image col-12 col-md-5 bgimg img-triangle">
                    <img className="img-responsive" src={imgWebDesign} alt="Design & Branding -- " />
                </div>
            </div>

            <div className="row services__block">
                <div className="services__image left-image col-12 col-md-5 bgimg img-diamond">
                    <img className="img-responsive" src={imgWebDev} alt="Design & Branding -- " />
                </div>
                <div className="services__content last-child right-content col-12 col-md-6">
                    <h3 className="color--amber-light">Web Development</h3>
                    <p>
                        Bring to the table win-win survival strategies to ensure proactive domination.
                        At the end of the day, going forward, a new normal that has evolved from generation
                        X is on the runway heading towards a streamlined cloud solution. User generated content
